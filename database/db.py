...
class Db:
    ...
    def insert_economy_eternal_role(self, roles_id):
        c = self.connect.cursor()
        c.execute("INSERT INTO economy (eternal_role_id) VALUES (?)", (roles_id,))
        self.connect.commit()

    def insert_economy_temporary_role(self, roles_id):
        c = self.connect.cursor()
        c.execute("INSERT INTO economy (temporary_role_id) VALUES (?)", (roles_id,))
        self.connect.commit()

    def insert_economy_worker_role(self, roles_id):
        c = self.connect.cursor()
        c.execute("INSERT INTO economy (worker_role_id) VALUES (?)", (roles_id,))
        self.connect.commit()
